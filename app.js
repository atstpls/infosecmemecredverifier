...
const client = {
  client_name: 'Infosec Meme Credential Verifier',
  logo_uri: 'https://infosecmeme.blob.core.windows.net/static/focused_ox_apprentice.png',
  tos_uri: 'https://www.microsoft.com/servicesagreement',
  client_purpose: 'To verify knowledge and skill level of meme use in the Infosec realm.'
}
...
// const credential = 'https://beta.did.msidentity.com/v1.0/156105cf-2fc2-4b27-ac8a-b40c05ef658f/verifiableCredential/contracts/InfosecMemeApprentice';
// const credential = 'https://beta.did.msidentity.com/v1.0/156105cf-2fc2-4b27-ac8a-b40c05ef658f/verifiableCredential/contracts/InfosecMemeJourneyman';
const credential = 'https://beta.did.msidentity.com/v1.0/156105cf-2fc2-4b27-ac8a-b40c05ef658f/verifiableCredential/contracts/InfosecMemeExpert';
// const credentialType = 'InfosecMemeApprentice';
// const credentialType = 'InfosecMemeJourneyman';
const credentialType = 'InfosecMemeExpert';
const issuerDid = ['did:ion:EiB5IW4w9Yxo_tHaYCtx-mlCNfi_s4wxShWxLgTNgE8xiA:'];
...
app.get('/presentation-response', async (req, res) => {
  ...
  if (req.session.verifiedCredential) {
    ...
    return res.send(`Success, ${presentedCredential.vc.credentialSubject.firstName} ${presentedCredential.vc.credentialSubject.lastName} is an ${credentialType}!`)  
  }
